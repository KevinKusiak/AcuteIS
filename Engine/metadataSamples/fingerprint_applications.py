...
def do_testssl(host, port, protocol, options, logfile):
    ...
    "OBJECTIVE: FIND HOST, PORT, PROTOCOL, OPTIONS, AND LOGFILE IN CMD"
...
#Find target to objectify and locate
#Self find of ip address on computer
#Locate viruses on computer